/**** BSIM4.5.0f Released by Xuemei (Jane) Xi 07/29/2005 ****/

/**********
 * Copyright 2005 Regents of the University of California. All rights reserved.
 * File: b4ld.c of BSIM4.5.0f.
...
/*
#define MAX_EXP 2.688117142e+43f
#define MIN_EXP 3.720075976e-44f
#define EXP_THRESHOLD 100.0f
*/
#define MAX_EXP 5.834617425e14f
#define MIN_EXP 1.713908431e-15f
#define EXP_THRESHOLD 34.0f
#define EPSSI 1.03594e-10f
#define Charge_q 1.60219e-19f
#define DELTA_1 0.02f
#define DELTA_2 0.02f
#define DELTA_3 0.02f
#define DELTA_4 0.02f
#define MM  3  /* smooth coeff */
#define DEXP(A,B,C) {                                                         \
        if (A > EXP_THRESHOLD) {                                              \
            B = MAX_EXP*(1.0f+(A)-EXP_THRESHOLD);                              \
            C = MAX_EXP;                                                      \
...
SPICE_REAL ceqgstot, dgstot_dvd, dgstot_dvg, dgstot_dvs, dgstot_dvb;
SPICE_REAL ceqgdtot, dgdtot_dvd, dgdtot_dvg, dgdtot_dvs, dgdtot_dvb;
SPICE_REAL gstot, gstotd, gstotg, gstots, gstotb, gspr, Rs, Rd;
SPICE_REAL gdtot, gdtotd, gdtotg, gdtots, gdtotb, gdpr;
SPICE_REAL vgs_eff, vgd_eff, dvgs_eff_dvg, dvgd_eff_dvg;
SPICE_REAL dRs_dvg, dRd_dvg, dRs_dvb, dRd_dvb;
SPICE_REAL dT0_dvg, dT1_dvb, dT3_dvg, dT3_dvb;
SPICE_REAL vses, vdes, vdedo, delvses, delvded, delvdes;
SPICE_REAL Isestot=0.0f, cseshat=0.0f, Idedtot=0.0f, cdedhat=0.0f;
#ifndef NEWCONV
SPICE_REAL tol0, tol1, tol2, tol3, tol4, tol5, tol6;
#endif

SPICE_REAL geltd, gcrg, gcrgg, gcrgd, gcrgs, gcrgb, ceqgcrg;
SPICE_REAL vges, vgms, vgedo, vgmdo, vged, vgmd, delvged, delvgmd;
SPICE_REAL delvges, delvgms, vgmb;
SPICE_REAL gcgmgmb=0.0f, gcgmdb=0.0f, gcgmsb=0.0f, gcdgmb, gcsgmb;
SPICE_REAL gcgmbb=0.0f, gcbgmb, qgmb, qgmid=0.0f, ceqqgmid;

SPICE_REAL vbd, vbs, vds, vgb, vgd, vgs, vgdo;
#ifndef PREDICTOR
SPICE_REAL xfact;
#endif
SPICE_REAL vdbs, vdbd, vsbs, vsbdo, vsbd;
SPICE_REAL delvdbs, delvdbd, delvsbs;
SPICE_REAL delvbd_jct, delvbs_jct, vbs_jct, vbd_jct;

SPICE_REAL SourceSatCurrent, DrainSatCurrent;
SPICE_REAL ag0, qgb, von, cbhat=0.0f, VgstNVt, ExpVgst;
SPICE_REAL ceqqb, ceqqd, ceqqg, ceqqjd=0.0f, ceqqjs=0.0f, ceq, geq;
SPICE_REAL cdrain, cdhat=0.0f, ceqdrn, ceqbd, ceqbs, ceqjd, ceqjs, gjbd, gjbs;
SPICE_REAL czbd, czbdsw, czbdswg, czbs, czbssw, czbsswg, evbd, evbs, arg, sarg;
SPICE_REAL delvbd, delvbs, delvds, delvgd, delvgs;
SPICE_REAL Vfbeff, dVfbeff_dVg, dVfbeff_dVb, V3, V4;
SPICE_REAL gcbdb, gcbgb, gcbsb, gcddb, gcdgb, gcdsb, gcgdb, gcggb, gcgsb, gcsdb;
SPICE_REAL gcgbb, gcdbb, gcsbb, gcbbb;
SPICE_REAL gcdbdb, gcsbsb;
SPICE_REAL gcsgb, gcssb, MJD, MJSWD, MJSWGD, MJS, MJSWS, MJSWGS;
SPICE_REAL qgate=0.0f, qbulk=0.0f, qdrn=0.0f, qsrc, cqgate, cqbody, cqdrn;
SPICE_REAL Vdb, Vds, Vgs, Vbs, Gmbs, FwdSum, RevSum;
SPICE_REAL Igidl, Ggidld, Ggidlg, Ggidlb;
SPICE_REAL Voxacc=0.0f, dVoxacc_dVg=0.0f, dVoxacc_dVb=0.0f;
SPICE_REAL Voxdepinv=0.0f, dVoxdepinv_dVg=0.0f, dVoxdepinv_dVd=0.0f, dVoxdepinv_dVb=0.0f;
SPICE_REAL VxNVt=0.0f, ExpVxNVt, Vaux=0.0f, dVaux_dVg=0.0f, dVaux_dVd=0.0f, dVaux_dVb=0.0f;
SPICE_REAL Igc, dIgc_dVg, dIgc_dVd, dIgc_dVb;
SPICE_REAL Igcs, dIgcs_dVg, dIgcs_dVd, dIgcs_dVb;
SPICE_REAL Igcd, dIgcd_dVg, dIgcd_dVd, dIgcd_dVb;
SPICE_REAL Igs, dIgs_dVg, dIgs_dVs, Igd, dIgd_dVg, dIgd_dVd;
SPICE_REAL Igbacc, dIgbacc_dVg, dIgbacc_dVb;
SPICE_REAL Igbinv, dIgbinv_dVg, dIgbinv_dVd, dIgbinv_dVb;
SPICE_REAL Pigcd, dPigcd_dVg, dPigcd_dVd, dPigcd_dVb;
SPICE_REAL Istoteq, gIstotg, gIstotd, gIstots, gIstotb;
SPICE_REAL Idtoteq, gIdtotg, gIdtotd, gIdtots, gIdtotb;
SPICE_REAL Ibtoteq, gIbtotg, gIbtotd, gIbtots, gIbtotb;
SPICE_REAL Igtoteq, gIgtotg, gIgtotd, gIgtots, gIgtotb;
SPICE_REAL Igstot=0.0f, cgshat=0.0f, Igdtot=0.0f, cgdhat=0.0f, Igbtot=0.0f, cgbhat=0.0f;
SPICE_REAL Vgs_eff, Vfb=0.0f, Vth_NarrowW;
SPICE_REAL Phis, dPhis_dVb, sqrtPhis, dsqrtPhis_dVb, Vth, dVth_dVb, dVth_dVd;
SPICE_REAL Vgst, dVgst_dVg, dVgst_dVb, dVgs_eff_dVg, Nvtms, Nvtmd;
SPICE_REAL Vtm, Vtm0;
SPICE_REAL n, dn_dVb, dn_dVd, voffcv, noff, dnoff_dVd, dnoff_dVb;
SPICE_REAL V0, CoxWLcen, QovCox, LINK;
SPICE_REAL DeltaPhi, dDeltaPhi_dVg, VgDP, dVgDP_dVg;
SPICE_REAL Cox, Tox, Tcen, dTcen_dVg, dTcen_dVd, dTcen_dVb;
SPICE_REAL Ccen, Coxeff, dCoxeff_dVd, dCoxeff_dVg, dCoxeff_dVb;
SPICE_REAL Denomi, dDenomi_dVg, dDenomi_dVd, dDenomi_dVb;
SPICE_REAL ueff, dueff_dVg, dueff_dVd, dueff_dVb; 
SPICE_REAL Esat, Vdsat;
SPICE_REAL EsatL, dEsatL_dVg, dEsatL_dVd, dEsatL_dVb;
SPICE_REAL dVdsat_dVg, dVdsat_dVb, dVdsat_dVd, Vasat, dAlphaz_dVg, dAlphaz_dVb; 
SPICE_REAL dVasat_dVg, dVasat_dVb, dVasat_dVd, Va, dVa_dVd, dVa_dVg, dVa_dVb; 
SPICE_REAL Vbseff, dVbseff_dVb, VbseffCV, dVbseffCV_dVb; 
SPICE_REAL Arg1, One_Third_CoxWL, Two_Third_CoxWL, Alphaz, CoxWL; 
SPICE_REAL T0=0.0f, dT0_dVg, dT0_dVd, dT0_dVb;
SPICE_REAL T1, dT1_dVg, dT1_dVd, dT1_dVb;
SPICE_REAL T2, dT2_dVg, dT2_dVd, dT2_dVb;
SPICE_REAL T3, dT3_dVg, dT3_dVd, dT3_dVb;
SPICE_REAL T4, dT4_dVd, dT4_dVb;
SPICE_REAL T5, dT5_dVg, dT5_dVd, dT5_dVb;
SPICE_REAL T6, dT6_dVg, dT6_dVd, dT6_dVb;
SPICE_REAL T7, dT7_dVg, dT7_dVd, dT7_dVb;
SPICE_REAL T8, dT8_dVg, dT8_dVd, dT8_dVb;
SPICE_REAL T9, dT9_dVg, dT9_dVd, dT9_dVb;
SPICE_REAL T10, dT10_dVg, dT10_dVb, dT10_dVd; 
SPICE_REAL T11, T12, T13, T14;
SPICE_REAL tmp, Abulk, dAbulk_dVb, Abulk0, dAbulk0_dVb;
SPICE_REAL Cclm, dCclm_dVg, dCclm_dVd, dCclm_dVb;
SPICE_REAL FP, dFP_dVg, PvagTerm, dPvagTerm_dVg, dPvagTerm_dVd, dPvagTerm_dVb;
SPICE_REAL VADITS, dVADITS_dVg, dVADITS_dVd;
SPICE_REAL Lpe_Vb, dDITS_Sft_dVb, dDITS_Sft_dVd;
SPICE_REAL VACLM, dVACLM_dVg, dVACLM_dVd, dVACLM_dVb;
SPICE_REAL VADIBL, dVADIBL_dVg, dVADIBL_dVd, dVADIBL_dVb;
SPICE_REAL Xdep, dXdep_dVb, lt1, dlt1_dVb, ltw, dltw_dVb, Delt_vth, dDelt_vth_dVb;
SPICE_REAL Theta0, dTheta0_dVb;
SPICE_REAL TempRatio, tmp1, tmp2, tmp3, tmp4;
SPICE_REAL DIBL_Sft, dDIBL_Sft_dVd, Lambda, dLambda_dVg;
SPICE_REAL Idtot, Ibtot, a1, ScalingFactor;

SPICE_REAL Vgsteff, dVgsteff_dVg, dVgsteff_dVd, dVgsteff_dVb; 
SPICE_REAL Vdseff, dVdseff_dVg, dVdseff_dVd, dVdseff_dVb; 
SPICE_REAL VdseffCV, dVdseffCV_dVg, dVdseffCV_dVd, dVdseffCV_dVb; 
SPICE_REAL diffVds, dAbulk_dVg;
SPICE_REAL beta, dbeta_dVg, dbeta_dVd, dbeta_dVb;
SPICE_REAL gche, dgche_dVg, dgche_dVd, dgche_dVb;
SPICE_REAL fgche1, dfgche1_dVg, dfgche1_dVd, dfgche1_dVb;
SPICE_REAL fgche2, dfgche2_dVg, dfgche2_dVd, dfgche2_dVb;
SPICE_REAL Idl, dIdl_dVg, dIdl_dVd, dIdl_dVb;
SPICE_REAL Idsa, dIdsa_dVg, dIdsa_dVd, dIdsa_dVb;
SPICE_REAL Ids, Gm, Gds, Gmb, devbs_dvb, devbd_dvb;
SPICE_REAL Isub, Gbd, Gbg, Gbb;
SPICE_REAL VASCBE, dVASCBE_dVg, dVASCBE_dVd, dVASCBE_dVb;
SPICE_REAL CoxeffWovL;
SPICE_REAL Rds, dRds_dVg, dRds_dVb, WVCox, WVCoxRds;
SPICE_REAL Vgst2Vtm, VdsatCV;
SPICE_REAL Leff, Weff, dWeff_dVg, dWeff_dVb;
SPICE_REAL AbulkCV, dAbulkCV_dVb;
SPICE_REAL qcheq, qdef, gqdef=0.0f, cqdef=0.0f, cqcheq=0.0f;
SPICE_REAL gcqdb=0.0f, gcqsb=0.0f, gcqgb=0.0f, gcqbb=0.0f;
SPICE_REAL dxpart, sxpart, ggtg, ggtd, ggts, ggtb;
SPICE_REAL ddxpart_dVd, ddxpart_dVg, ddxpart_dVb, ddxpart_dVs;
SPICE_REAL dsxpart_dVd, dsxpart_dVg, dsxpart_dVb, dsxpart_dVs;
SPICE_REAL gbspsp, gbbdp, gbbsp, gbspg, gbspb, gbspdp; 
SPICE_REAL gbdpdp, gbdpg, gbdpb, gbdpsp; 
SPICE_REAL qgdo, qgso, cgdo, cgso;
SPICE_REAL Cgg, Cgd, Cgb, Cdg, Cdd, Cds;
SPICE_REAL Csg, Csd, Css, Csb, Cbg, Cbd, Cbb;
SPICE_REAL Cgg1, Cgb1, Cgd1, Cbg1, Cbb1, Cbd1, Qac0, Qsub0;
SPICE_REAL dQac0_dVg, dQac0_dVb, dQsub0_dVg, dQsub0_dVd, dQsub0_dVb;
SPICE_REAL ggidld, ggidlg, ggidlb, ggislg, ggislb, ggisls;
SPICE_REAL Igisl, Ggislg, Ggislb, Ggisls;
SPICE_REAL Nvtmrs, Nvtmrssw, Nvtmrsswg;

SPICE_REAL vs, Fsevl, dvs_dVg, dvs_dVd, dvs_dVb, dFsevl_dVg, dFsevl_dVd, dFsevl_dVb;
SPICE_REAL vgdx, vgsx;
struct bsim4v5SizeDependParam *pParam;
int ByPass, ChargeComputationNeeded, error, Check, Check1, Check2;

 SPICE_REAL m;

ScalingFactor = 1.0e-9f;
		  ...
		  vdes = 0.11f;
	  	  vses = -0.01f;
                  vgs = vges = vgms = model->BSIM4v5type 
                                    * here->BSIM4v5vth0 + 0.1f;
                  vbs = vdbs = vsbs = 0.0f;
              }
          }
	  else if ((ckt->CKTmode & (MODEINITJCT | MODEINITFIX)) && 
                  (here->BSIM4v5off)) 
          {   vds = vgs = vbs = vges = vgms = 0.0f;
              vdbs = vsbs = vdes = vses = qdef = 0.0f;
	  }
          else
	  {
#ifndef PREDICTOR
	       ...
	       {   xfact = ckt->CKTdelta / ckt->CKTdeltaOld[1];
                   ...
                   *(ckt->CKTstate0 + here->BSIM4v5vdbs) =
                   ...
                   vdbs = (1.0f + xfact)* (*(ckt->CKTstate1 + here->BSIM4v5vdbs))
		   ...
		   cgbhat = here->BSIM4v5Igb + here->BSIM4v5gIgbg * delvgs + here->BSIM4v5gIgbd
			 ...
			 - here->BSIM4v5ggidlg * delvgs - here->BSIM4v5ggidlb * delvbs; 
               ...
               if ((SPICE_FABS(delvds) < (ckt->CKTreltol * MAX(SPICE_FABS(vds),
                   SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vds))) + ckt->CKTvoltTol)))
               if ((SPICE_FABS(delvgs) < (ckt->CKTreltol * MAX(SPICE_FABS(vgs),
                   SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vgs))) + ckt->CKTvoltTol)))
               if ((SPICE_FABS(delvbs) < (ckt->CKTreltol * MAX(SPICE_FABS(vbs),
                   SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vbs))) + ckt->CKTvoltTol)))
               if ((SPICE_FABS(delvbd) < (ckt->CKTreltol * MAX(SPICE_FABS(vbd),
                   SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vbd))) + ckt->CKTvoltTol)))
	       if ((here->BSIM4v5rgateMod == 0) || (here->BSIM4v5rgateMod == 1) 
      		   || (SPICE_FABS(delvges) < (ckt->CKTreltol * MAX(SPICE_FABS(vges),
		   SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vges))) + ckt->CKTvoltTol)))
	       if ((here->BSIM4v5rgateMod != 3) || (SPICE_FABS(delvgms) < (ckt->CKTreltol
                   * MAX(SPICE_FABS(vgms), SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vgms)))
                   + ckt->CKTvoltTol)))
               if ((!here->BSIM4v5rbodyMod) || (SPICE_FABS(delvdbs) < (ckt->CKTreltol
                   * MAX(SPICE_FABS(vdbs), SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vdbs)))
                   + ckt->CKTvoltTol)))
               if ((!here->BSIM4v5rbodyMod) || (SPICE_FABS(delvdbd) < (ckt->CKTreltol
                   * MAX(SPICE_FABS(vdbd), SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vdbd)))
                   + ckt->CKTvoltTol)))
               if ((!here->BSIM4v5rbodyMod) || (SPICE_FABS(delvsbs) < (ckt->CKTreltol
                   * MAX(SPICE_FABS(vsbs), SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vsbs)))
                   + ckt->CKTvoltTol)))
               if ((!model->BSIM4v5rdsMod) || (SPICE_FABS(delvses) < (ckt->CKTreltol
                   * MAX(SPICE_FABS(vses), SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vses)))
                   + ckt->CKTvoltTol)))
               if ((!model->BSIM4v5rdsMod) || (SPICE_FABS(delvdes) < (ckt->CKTreltol
                   * MAX(SPICE_FABS(vdes), SPICE_FABS(*(ckt->CKTstate0 + here->BSIM4v5vdes)))
                   + ckt->CKTvoltTol)))
               if ((SPICE_FABS(cdhat - Idtot) < ckt->CKTreltol
                   * MAX(SPICE_FABS(cdhat), SPICE_FABS(Idtot)) + ckt->CKTabstol))
               if ((SPICE_FABS(cbhat - Ibtot) < ckt->CKTreltol
                   * MAX(SPICE_FABS(cbhat), SPICE_FABS(Ibtot)) + ckt->CKTabstol))
               if ((!model->BSIM4v5igcMod) || ((SPICE_FABS(cgshat - Igstot) < ckt->CKTreltol
                   * MAX(SPICE_FABS(cgshat), SPICE_FABS(Igstot)) + ckt->CKTabstol)))
               if ((!model->BSIM4v5igcMod) || ((SPICE_FABS(cgdhat - Igdtot) < ckt->CKTreltol
                   * MAX(SPICE_FABS(cgdhat), SPICE_FABS(Igdtot)) + ckt->CKTabstol)))
               if ((!model->BSIM4v5igbMod) || ((SPICE_FABS(cgbhat - Igbtot) < ckt->CKTreltol
                   * MAX(SPICE_FABS(cgbhat), SPICE_FABS(Igbtot)) + ckt->CKTabstol)))
               if ((!model->BSIM4v5rdsMod) || ((SPICE_FABS(cseshat - Isestot) < ckt->CKTreltol
                   * MAX(SPICE_FABS(cseshat), SPICE_FABS(Isestot)) + ckt->CKTabstol)))
               if ((!model->BSIM4v5rdsMod) || ((SPICE_FABS(cdedhat - Idedtot) < ckt->CKTreltol
                   * MAX(SPICE_FABS(cdedhat), SPICE_FABS(Idedtot)) + ckt->CKTabstol)))
               {   vds = *(ckt->CKTstate0 + here->BSIM4v5vds);
                   vgs = *(ckt->CKTstate0 + here->BSIM4v5vgs);
                   vbs = *(ckt->CKTstate0 + here->BSIM4v5vbs);
		   vges = *(ckt->CKTstate0 + here->BSIM4v5vges);
...
***/
		   ...
		   {   ByPass = 1;
               ...
               von = here->BSIM4v5von;
               if (*(ckt->CKTstate0 + here->BSIM4v5vds) >= 0.0f)
	  ...
	  if ((here->BSIM4v5Aseff <= 0.0f) && (here->BSIM4v5Pseff <= 0.0f))
	  {   SourceSatCurrent = 1.0e-14f;
	  }
          else
	  ...
	  {   switch(model->BSIM4v5dioMod)
              {   case 0:
                      evbs = SPICE_EXP(vbs_jct / Nvtms);
                      T1 = model->BSIM4v5xjbvs * SPICE_EXP(-(model->BSIM4v5bvs + vbs_jct) / Nvtms);
		      ...
		      here->BSIM4v5cbs = SourceSatCurrent * (evbs + here->BSIM4v5XExpBVS
				     - T1 - 1.0f) + ckt->CKTgmin * vbs_jct;
		      break;
                  case 1:
		      T2 = vbs_jct / Nvtms;
	              if (T2 < -EXP_THRESHOLD)
		      {   here->BSIM4v5gbs = ckt->CKTgmin;
                          here->BSIM4v5cbs = SourceSatCurrent * (MIN_EXP - 1.0f)
                                         + ckt->CKTgmin * vbs_jct;
                      }
		      else if (vbs_jct <= here->BSIM4v5vjsmFwd)
		      {   evbs = SPICE_EXP(T2);
			  here->BSIM4v5gbs = SourceSatCurrent * evbs / Nvtms + ckt->CKTgmin;
                          here->BSIM4v5cbs = SourceSatCurrent * (evbs - 1.0f)
                                         + ckt->CKTgmin * vbs_jct;
	              }
		      else
			  ...
			  {   T2 = SPICE_EXP(-T1);
			      T3 = -T2 /Nvtms;
					 ...
					 + ckt->CKTgmin;
			  here->BSIM4v5cbs = SourceSatCurrent * (evbs + here->BSIM4v5XExpBVS - 1.0f
	  ...
	  if ((here->BSIM4v5Adeff <= 0.0f) && (here->BSIM4v5Pdeff <= 0.0f))
	  {   DrainSatCurrent = 1.0e-14f;
	  }
          else
	  ...
	  {   here->BSIM4v5gbd = ckt->CKTgmin;
          ...
          {   switch(model->BSIM4v5dioMod)
              {   case 0:
                      evbd = SPICE_EXP(vbd_jct / Nvtmd);
                      T1 = model->BSIM4v5xjbvd * SPICE_EXP(-(model->BSIM4v5bvd + vbd_jct) / Nvtmd);
                      /* WDLiu: Magic T1 in this form; different from BSIM4v5 beta. */
                      here->BSIM4v5gbd = DrainSatCurrent * (evbd + T1) / Nvtmd + ckt->CKTgmin;
                      here->BSIM4v5cbd = DrainSatCurrent * (evbd + here->BSIM4v5XExpBVD
                                     - T1 - 1.0f) + ckt->CKTgmin * vbd_jct;
                      break;
                  case 1:
		      T2 = vbd_jct / Nvtmd;
                      if (T2 < -EXP_THRESHOLD)
                      {   here->BSIM4v5gbd = ckt->CKTgmin;
                          here->BSIM4v5cbd = DrainSatCurrent * (MIN_EXP - 1.0f)
                                         + ckt->CKTgmin * vbd_jct;
                      }
                      else if (vbd_jct <= here->BSIM4v5vjdmFwd)
                      {   evbd = SPICE_EXP(T2);
                          here->BSIM4v5gbd = DrainSatCurrent * evbd / Nvtmd + ckt->CKTgmin;
                          here->BSIM4v5cbd = DrainSatCurrent * (evbd - 1.0f)
                                         + ckt->CKTgmin * vbd_jct;
                      }
                      else
                  ...
                  case 2:
                      ...
                      {   T0 = vbd_jct / Nvtmd;
                          ...
                          here->BSIM4v5gbd = DrainSatCurrent * (devbd_dvb - model->BSIM4v5xjbvd * T3)
                                         + ckt->CKTgmin;
                          here->BSIM4v5cbd = DrainSatCurrent * (evbd + here->BSIM4v5XExpBVD - 1.0f
	   ...
	   /* trap-assisted tunneling and recombination current for reverse bias  */
        ...
        { T9 = 1.0e3f; 
          ...
          T9 = 1.0f / (model->BSIM4v5vtss - vbs_jct);
       ...
       if ((model->BSIM4v5vtsd - vbd_jct) < (model->BSIM4v5vtsd * 1e-3) )
        { T9 = 1.0e3f;
          ...
          T9 = 1.0f / (model->BSIM4v5vtsd - vbd_jct);
        ...
        { T9 = 1.0e3f; 
          ...
          T9 = 1.0f / (model->BSIM4v5vtssws - vbs_jct);
        ...
        { T9 = 1.0e3f; 
          ...
          T9 = 1.0f / (model->BSIM4v5vtsswd - vbd_jct);
        ...
        { T9 = 1.0e3f; 
          ...
          T9 = 1.0f / (model->BSIM4v5vtsswgs - vbs_jct);
        ...
        { T9 = 1.0e3f; 
          ...
          T9 = 1.0f / (model->BSIM4v5vtsswgd - vbd_jct);
	  ...
	  here->BSIM4v5cbs -= here->BSIM4v5SjctTempRevSatCur * (T1 - 1.0f)
	  			+ here->BSIM4v5SswTempRevSatCur * (T3 - 1.0f)
	  			+ here->BSIM4v5SswgTempRevSatCur * (T5 - 1.0f); 
	  ...
	  here->BSIM4v5cbd -= here->BSIM4v5DjctTempRevSatCur * (T2 - 1.0f) 
	  			+ here->BSIM4v5DswTempRevSatCur * (T4 - 1.0f)
	  			+ here->BSIM4v5DswgTempRevSatCur * (T6 - 1.0f); 
	  ...
	  T0 = Vbs - here->BSIM4v5vbsc - 0.001f;
	  T1 = SPICE_SQRT(T0 * T0 - 0.004f * here->BSIM4v5vbsc);
	  if (T0 >= 0.0f)
	  {   Vbseff = here->BSIM4v5vbsc + 0.5f * (T0 + T1);
              dVbseff_dVb = 0.5f * (1.0f + T0 / T1);
	  }
	  else
	  {   T2 = -0.002f / (T1 - T0);
	      Vbseff = here->BSIM4v5vbsc * (1.0f + T2);
	      dVbseff_dVb = T2 * here->BSIM4v5vbsc / T1;
	  }

	/* JX: Correction to forward body bias  */
	  T9 = 0.95f * pParam->BSIM4v5phi;
	  T0 = T9 - Vbseff - 0.001f;
	  T1 = SPICE_SQRT(T0 * T0 + 0.004f * T9);
	  Vbseff = T9 - 0.5f * (T0 + T1);
          dVbseff_dVb *= 0.5f * (1.0f + T0 / T1);

          Phis = pParam->BSIM4v5phi - Vbseff;
          dPhis_dVb = -1.0f;
          sqrtPhis = SPICE_SQRT(Phis);
          dsqrtPhis_dVb = -0.5f / sqrtPhis; 
	  ...
	  {   T4 = 1.0f / (3.0f + 8.0f * T0);
	      T1 = (1.0f + 3.0f * T0) * T4; 
	      T2 = pParam->BSIM4v5dvt2 * T4 * T4;
	  }
          lt1 = model->BSIM4v5factor1 * T3 * T1;
          dlt1_dVb = model->BSIM4v5factor1 * (0.5f / T3 * T1 * dXdep_dVb + T3 * T2);
	  ...
	  {   T4 = 1.0f / (3.0f + 8.0f * T0);
          ...
          dltw_dVb = model->BSIM4v5factor1 * (0.5f / T3 * T1 * dXdep_dVb + T3 * T2);
          ...
          {   T1 = SPICE_EXP(T0);
              T2 = T1 - 1.0f;
              T3 = T2 * T2;
              T4 = T3 + 2.0f * T1 * MIN_EXP;
              Theta0 = T1 / T4;
              dT1_dVb = -T0 * T1 * dlt1_dVb / lt1;
              dTheta0_dVb = dT1_dVb * (T4 - 2.0f * T1 * (T2 + MIN_EXP)) / T4 / T4;
          }
          else
          {   Theta0 = 1.0f / (MAX_EXP - 2.0f); /* 3.0f * MIN_EXP omitted */
              dTheta0_dVb = 0.0f;
          }
          ...
          {   T1 = SPICE_EXP(T0);
              ...
              dT5_dVb = dT1_dVb * (T4 - 2.0f * T1 * (T2 + MIN_EXP)) / T4 / T4;
          }
          else
          {   T5 = 1.0f / (MAX_EXP - 2.0f); /* 3.0f * MIN_EXP omitted */
              dT5_dVb = 0.0f;
          }
          ...
          TempRatio =  ckt->CKTtemp / model->BSIM4v5tnom - 1.0f;
          T0 = SPICE_SQRT(1.0f + pParam->BSIM4v5lpe0 / Leff);
          T1 = pParam->BSIM4v5k1ox * (T0 - 1.0f) * pParam->BSIM4v5sqrtPhi
	  ...
	  dDIBL_Sft_dVd = T3 * pParam->BSIM4v5theta0vb0;
 	  ...
 	  Lpe_Vb = SPICE_SQRT(1.0f + pParam->BSIM4v5lpeb / Leff);
	  ...
	  {   T0 = 1.0f / (3.0f + 8.0f * tmp4);
 	  ...
 	  if (pParam->BSIM4v5dvtp0 > 0.0f)
          {   T0 = -pParam->BSIM4v5dvtp1 * Vds;
              ...
              T3 = Leff + pParam->BSIM4v5dvtp0 * (1.0f + T2);
              dT3_dVd = pParam->BSIM4v5dvtp0 * dT2_dVd;
              if (model->BSIM4v5tempMod < 2)
              {
                T4 = Vtm * SPICE_LOG(Leff / T3);
                dT4_dVd = -Vtm * dT3_dVd / T3;
              }
              else
              {
                T4 = model->BSIM4v5vtm0 * SPICE_LOG(Leff / T3);
	  ...
	  {   T10 = Vtm * SPICE_LOG(1.0f + MIN_EXP);
              dT10_dVg = 0.0f;
              dT10_dVd = T10 * dn_dVd;
              dT10_dVb = T10 * dn_dVb;
	      T10 *= n;
	  ...
	  {   ExpVgst = SPICE_EXP(T2);
	      T3 = Vtm * SPICE_LOG(1.0f + ExpVgst);
              T10 = n * T3;
              dT10_dVg = pParam->BSIM4v5mstar * ExpVgst / (1.0f + ExpVgst);
	  ...
	  T1 = pParam->BSIM4v5voffcbn - (1.0f - pParam->BSIM4v5mstar) * Vgst;
	  T2 = T1 / T0;
          if (T2 < -EXP_THRESHOLD)
	      ...
	      T5 = T1 * T4 / T0;
              ...
              dT9_dVg = T3 * (pParam->BSIM4v5mstar - 1.0f) * ExpVgst / Vtm;
	  ...
	  T11 = T9 * T9;
          ...
          Weff = pParam->BSIM4v5weff - 2.0f * (pParam->BSIM4v5dwg * Vgsteff 
               + pParam->BSIM4v5dwb * T9); 
          dWeff_dVg = -2.0f * pParam->BSIM4v5dwg;
          dWeff_dVb = -2.0f * pParam->BSIM4v5dwb * dsqrtPhis_dVb;

          if (Weff < 2.0e-8f) /* to avoid the discontinuity problem due to Weff*/
	  {   T0 = 1.0f / (6.0e-8f - 2.0f * Weff);
	      Weff = 2.0e-8f * (4.0e-8f - Weff) * T0;
	      T0 *= T0 * 4.0e-16f;
              dWeff_dVg *= T0;
	      dWeff_dVb *= T0;
          }
	  ...
	  if (model->BSIM4v5rdsMod == 1)
	      Rds = dRds_dVg = dRds_dVb = 0.0f;
          else
          {   T0 = 1.0f + pParam->BSIM4v5prwg * Vgsteff;
	      dT0_dVg = -pParam->BSIM4v5prwg / T0 / T0;
	      T1 = pParam->BSIM4v5prwb * T9;
	      dT1_dVb = pParam->BSIM4v5prwb * dsqrtPhis_dVb;

	      T2 = 1.0f / T0 + T1;
	      T3 = T2 + SPICE_SQRT(T2 * T2 + 0.01f); /* 0.01f = 4.0f * 0.05f * 0.05f */
	      dT3_dVg = 1.0f + T2 / (T3 - T2);
	      dT3_dVb = dT3_dVg * dT1_dVb;
	      dT3_dVg *= dT0_dVg;

	      T4 = pParam->BSIM4v5rds0 * 0.5f;
	      Rds = pParam->BSIM4v5rdswmin + T3 * T4;
              dRds_dVg = T4 * dT3_dVg;
              dRds_dVb = T4 * dT3_dVb;

	      if (Rds > 0.0f)
		  here->BSIM4v5grdsw = 1.0f / Rds; 
	      else
                  here->BSIM4v5grdsw = 0.0f;
          }
	  
          /* Calculate Abulk */
	  T9 = 0.5f * pParam->BSIM4v5k1ox * Lpe_Vb / sqrtPhis;
          T1 = T9 + here->BSIM4v5k2ox - pParam->BSIM4v5k3b * Vth_NarrowW;
          dT1_dVb = -T9 / sqrtPhis * dsqrtPhis_dVb;

          T9 = SPICE_SQRT(pParam->BSIM4v5xj * Xdep);
          tmp1 = Leff + 2.0f * T9;
          T5 = Leff / tmp1; 
          ...
          if (Abulk0 < 0.1f) /* added to avoid the problems caused by Abulk0 */
	  {   T9 = 1.0f / (3.0f - 20.0f * Abulk0);
	      Abulk0 = (0.2f - Abulk0) * T9;
	      dAbulk0_dVb *= T9 * T9;
	  }

          if (Abulk < 0.1f)
	  {   T9 = 1.0f / (3.0f - 20.0f * Abulk);
	      Abulk = (0.2f - Abulk) * T9;
              T10 = T9 * T9;
	      dAbulk_dVb *= T10;
              dAbulk_dVg *= T10;
	  ...
	  Abulk0 *= T0;
          ...
          {   T0 = Vgsteff + Vth + Vth;
              ...
              T7 = - 2.0f * T6 / T0;
              dDenomi_dVg = (T2 + 2.0f * pParam->BSIM4v5ub * T3) / model->BSIM4v5toxe + T7;
              dDenomi_dVd = dDenomi_dVg * 2.0f * dVth_dVd;
              dDenomi_dVb = dDenomi_dVg * 2.0f * dVth_dVb + pParam->BSIM4v5uc * T3;
          }
          else if (model->BSIM4v5mobMod == 1)
          {   T0 = Vgsteff + Vth + Vth;
              T2 = 1.0f + pParam->BSIM4v5uc * Vbseff;
              T3 = T0 / model->BSIM4v5toxe;
              T4 = T3 * (pParam->BSIM4v5ua + pParam->BSIM4v5ub * T3);
              T6 = pParam->BSIM4v5ud / T3 / T3 * Vth * Vth;
              T5 = T4 * T2 + T6;
              T7 = - 2.0f * T6 / T0;
              dDenomi_dVg = (pParam->BSIM4v5ua + 2.0f * pParam->BSIM4v5ub * T3) * T2
                          / model->BSIM4v5toxe + T7;
              dDenomi_dVd = dDenomi_dVg * 2.0f * dVth_dVd;
              dDenomi_dVb = dDenomi_dVg * 2.0f * dVth_dVb + pParam->BSIM4v5uc * T4;
          }
	  else
	  {   T0 = (Vgsteff + here->BSIM4v5vtfbphi1) / model->BSIM4v5toxe;
	      T1 = SPICE_EXP(pParam->BSIM4v5eu * SPICE_LOG(T0));
	  ...
	  T9 = -ueff / Denomi;
          ...
          Esat = 2.0f * here->BSIM4v5vsattemp / ueff;
	  ...
	  {   T0 = 1.0f - pParam->BSIM4v5a2;
	      T1 = T0 - pParam->BSIM4v5a1 * Vgsteff - 0.0001f;
	      T2 = SPICE_SQRT(T1 * T1 + 0.0004f * T0);
	      Lambda = pParam->BSIM4v5a2 + T0 - 0.5f * (T1 + T2);
	      dLambda_dVg = 0.5f * pParam->BSIM4v5a1 * (1.0f + T1 / T2);
	  }
	  else
	  {   T1 = pParam->BSIM4v5a2 + pParam->BSIM4v5a1 * Vgsteff - 0.0001f;
	      T2 = SPICE_SQRT(T1 * T1 + 0.0004f * pParam->BSIM4v5a2);
	      Lambda = 0.5f * (T1 + T2);
	      dLambda_dVg = 0.5f * pParam->BSIM4v5a1 * (1.0f + T1 / T2);
	  }

          Vgst2Vtm = Vgsteff + 2.0f * Vtm;
          if (Rds > 0)
          ...
          if ((Rds == 0.0f) && (Lambda == 1.0f))
          {   T0 = 1.0f / (Abulk * EsatL + Vgst2Vtm);
              tmp1 = 0.0f;
	      T1 = T0 * T0;
	      T2 = Vgst2Vtm * T0;
              T3 = EsatL * Vgst2Vtm;
              ...
              dT0_dVg = -(Abulk * dEsatL_dVg + EsatL * dAbulk_dVg + 1.0f) * T1;
	      ...
	      T7 = Vgst2Vtm * T9;
              ...
              T0 = 2.0f * Abulk * (T9 - 1.0f + 1.0f / Lambda); 
              dT0_dVg = 2.0f * (T8 * tmp2 - Abulk * tmp1
		      + (2.0f * T9 + 1.0f / Lambda - 1.0f) * dAbulk_dVg);
             
              dT0_dVb = 2.0f * (T8 * (2.0f / Abulk * dAbulk_dVb + tmp3)
		      + (1.0f / Lambda - 1.0f) * dAbulk_dVb);
	      dT0_dVd = 0.0f; 
              T1 = Vgst2Vtm * (2.0f / Lambda - 1.0f) + Abulk * EsatL + 3.0f * T7;
             
              dT1_dVg = (2.0f / Lambda - 1.0f) - 2.0f * Vgst2Vtm * tmp1
		      + Abulk * dEsatL_dVg + EsatL * dAbulk_dVg + 3.0f * (T9
		      + T7 * tmp2 + T6 * dAbulk_dVg);
              dT1_dVb = Abulk * dEsatL_dVb + EsatL * dAbulk_dVb
	              + 3.0f * (T6 * dAbulk_dVb + T7 * tmp3);
              dT1_dVd = Abulk * dEsatL_dVd;

              T2 = Vgst2Vtm * (EsatL + 2.0f * T6);
              dT2_dVg = EsatL + Vgst2Vtm * dEsatL_dVg
		      + T6 * (4.0f + 2.0f * Vgst2Vtm * tmp2);
              dT2_dVb = Vgst2Vtm * (dEsatL_dVb + 2.0f * T6 * tmp3);
              dT2_dVd = Vgst2Vtm * dEsatL_dVd;

              T3 = SPICE_SQRT(T1 * T1 - 2.0f * T0 * T2);
              Vdsat = (T1 - T3) / T0;

              dT3_dVg = (T1 * dT1_dVg - 2.0f * (T0 * dT2_dVg + T2 * dT0_dVg))
	              / T3;
              dT3_dVd = (T1 * dT1_dVd - 2.0f * (T0 * dT2_dVd + T2 * dT0_dVd))
		      / T3;
              dT3_dVb = (T1 * dT1_dVb - 2.0f * (T0 * dT2_dVb + T2 * dT0_dVb))
		      / T3;
          ...
          dT1_dVg = dVdsat_dVg;
          dT1_dVd = dVdsat_dVd - 1.0f;
          dT1_dVb = dVdsat_dVb;

          T2 = SPICE_SQRT(T1 * T1 + 4.0f * pParam->BSIM4v5delta * Vdsat);
	  T0 = T1 / T2;
   	  T9 = 2.0f * pParam->BSIM4v5delta;
	  T3 = T9 / T2;
	  ...
	  if (T1 >= 0.0f)
	  {   Vdseff = Vdsat - 0.5f * (T1 + T2);
	      dVdseff_dVg = dVdsat_dVg - 0.5f * (dT1_dVg + dT2_dVg);
              dVdseff_dVd = dVdsat_dVd - 0.5f * (dT1_dVd + dT2_dVd);
              dVdseff_dVb = dVdsat_dVb - 0.5f * (dT1_dVb + dT2_dVb);
	  }
	  else
	  {   T4 = T9 / (T2 - T1);
	      T5 = 1.0f - T4;
          ...
          /* Velocity Overshoot */
        if((model->BSIM4v5lambdaGiven) && (model->BSIM4v5lambda > 0.0f) )
        {  
          T1 =  Leff * ueff;
          ...
          T5 = 1.0f / (Esat * pParam->BSIM4v5litl);
          T4 = -T5 / EsatL;
          ...
          dT6_dVd = dT5_dVd * diffVds + (1.0f - dVdseff_dVd) * T5;
          ...
          if(T10 == 1.0f)
                dT10_dVg = dT10_dVd = dT10_dVb = 0.0f;
          ...
          /* Calculate Vasat */
          tmp4 = 1.0f - 0.5f * Abulk * Vdsat / Vgst2Vtm;
          T9 = WVCoxRds * Vgsteff;
	  T8 = T9 / Vgst2Vtm;
          T0 = EsatL + Vdsat + 2.0f * T9 * tmp4;
         
          T7 = 2.0f * WVCoxRds * tmp4;
          dT0_dVg = dEsatL_dVg + dVdsat_dVg + T7 * (1.0f + tmp2 * Vgsteff)
          ...
          T9 = WVCoxRds * Abulk; 
          T1 = 2.0f / Lambda - 1.0f + T9; 
          dT1_dVg = -2.0f * tmp1 +  WVCoxRds * (Abulk * tmp2 + dAbulk_dVg);
	  ...
	  /* Calculate Idl first */
          ...
          tmp2 = 2.0e8f * model->BSIM4v5toxp;
          dT0_dVg = 1.0f / tmp2;
          T0 = (Vgsteff + tmp1) * dT0_dVg;

          tmp3 = SPICE_EXP(0.7f * SPICE_LOG(T0));
          T1 = 1.0f + tmp3;
          T2 = 0.7f * tmp3 / T0;
          Tcen = 1.9e-9f / T1;
          ...
          T0 = 1.0f - 0.5f * Vdseff * here->BSIM4v5AbovVgst2Vtm;
          dT0_dVg = -0.5f * (Abulk * dVdseff_dVg
                  - Abulk * Vdseff / Vgst2Vtm + Vdseff * dAbulk_dVg) / Vgst2Vtm;
          dT0_dVd = -0.5f * Abulk * dVdseff_dVd / Vgst2Vtm;
          dT0_dVb = -0.5f * (Abulk * dVdseff_dVb + dAbulk_dVb * Vdseff)
                  / Vgst2Vtm;
	  ...
	  if (pParam->BSIM4v5fprout <= 0.0f)
	  {   FP = 1.0f;
	      dFP_dVg = 0.0f;
	  }
	  else
	  {   T9 = pParam->BSIM4v5fprout * SPICE_SQRT(Leff) / Vgst2Vtm;
              FP = 1.0f / (1.0f + T9);
          ...
          if (T9 > -0.9f)
          {   PvagTerm = 1.0f + T9;
              dPvagTerm_dVg = T8 * (1.0f - Vgsteff * dEsatL_dVg / EsatL);
              dPvagTerm_dVb = -T9 * dEsatL_dVb / EsatL;
              dPvagTerm_dVd = -T9 * dEsatL_dVd / EsatL;
          }
          else
          {   T4 = 1.0f / (17.0f + 20.0f * T9);
              PvagTerm = (0.8f + T9) * T4;
              T4 *= T4;
              dPvagTerm_dVg = T8 * (1.0f - Vgsteff * dEsatL_dVg / EsatL) * T4;
              T9 *= T4 / EsatL;
              dPvagTerm_dVb = -T9 * dEsatL_dVb;
              dPvagTerm_dVd = -T9 * dEsatL_dVd;
          }

          if ((pParam->BSIM4v5pclm > MIN_EXP) && (diffVds > 1.0e-10f))
	  {   T0 = 1.0f + Rds * Idl;
	      ...
	      T1 = Leff + T2;
              ...
              dVACLM_dVd = dCclm_dVd * diffVds + (1.0f - dVdseff_dVd) * Cclm;
          }
          else
          {   VACLM = Cclm = MAX_EXP;
              dVACLM_dVd = dVACLM_dVg = dVACLM_dVb = 0.0f;
              dCclm_dVd = dCclm_dVg = dCclm_dVb = 0.0f;
          }
	  ...
	  {   T8 = Abulk * Vdsat;
	      T0 = Vgst2Vtm * T8;
              ...
              T1 = Vgst2Vtm + T8;
              dT1_dVg = 1.0f + Abulk * dVdsat_dVg + Vdsat * dAbulk_dVg;
	      ...
	      T2 = pParam->BSIM4v5thetaRout;
              ...
              dVADIBL_dVg = (1.0f - dT0_dVg / T1 + T0 * dT1_dVg / T9) / T2;
	  ...
	  {   VADIBL = MAX_EXP;
              dVADIBL_dVd = dVADIBL_dVg = dVADIBL_dVb = 0.0f;
          }
          ...
          {   T2 = 1.0f + model->BSIM4v5pditsl * Leff;
              VADITS = (1.0f + T2 * T1) / pParam->BSIM4v5pdits;
	  ...
	  /* Add DIBL to Ids */
          ...
          dIdsa_dVd = T0 * dIdl_dVd + Idl
                    * (1.0f - dVdseff_dVd - T9 * dVADIBL_dVd) / VADIBL;
          ...
          dIdsa_dVd = T0 * dIdsa_dVd + Idsa 
		    * (1.0f - dVdseff_dVd - T9 * dVADITS_dVd) / VADITS;
          dIdsa_dVb = T0 * dIdsa_dVb - Idsa * dVdseff_dVb / VADITS;
          Idsa *= T0;

          /* Add CLM to Ids */
          T0 = SPICE_LOG(Va / Vasat);
          ...
          if ((tmp <= 0.0f) || (pParam->BSIM4v5beta0 <= 0.0f))
          {   Isub = Gbd = Gbb = Gbg = 0.0f;
          }
          else
          {   T2 = tmp / Leff;
              if (diffVds > pParam->BSIM4v5beta0 / EXP_THRESHOLD)
              {   T0 = -pParam->BSIM4v5beta0 / diffVds;
                  T1 = T2 * diffVds * SPICE_EXP(T0);
                  T3 = T1 / diffVds * (T0 - 1.0f);
                  dT1_dVg = T3 * dVdseff_dVg;
                  dT1_dVd = T3 * (dVdseff_dVd - 1.0f);
	     ...
	     * (dVdseff_dVg + T9 * dVASCBE_dVg) / VASCBE;
	      ...
	      * (1.0f - dVdseff_dVd - T9 * dVASCBE_dVd) / VASCBE;
	  ...
	  tmp3 = Gm;
        ...
        if((model->BSIM4v5vtlGiven) && (model->BSIM4v5vtl > 0.0f) ) {
          T12 = 1.0f / Leff / CoxeffWovL;
          T11 = T12 / Vgsteff;
          T10 = -T11 / Vgsteff;
          vs = cdrain * T11; /* vs */
          ...
          if(T1 > 0.0f)  
          {	T2 = 1.0f + SPICE_EXP(T0 * SPICE_LOG(T1));
          	T3 = (T2 - 1.0f) * T0 / vs; 
          	Fsevl = 1.0f / SPICE_EXP(SPICE_LOG(T2)/ T0);
          	dT2_dVg = T3 * dvs_dVg;
          	dT2_dVd = T3 * dvs_dVd;
          	dT2_dVb = T3 * dvs_dVb;
          	T4 = -1.0f / T0 * Fsevl / T2;
          ...
          if( here->BSIM4v5IdovVds <= 1.0e-9f) here->BSIM4v5IdovVds = 1.0e-9f;
	  ...
	  {   /* Rs(V) */
	      ...
	      /* Rd(V) */
              ...
              T0 = 1.0f + pParam->BSIM4v5prwg * vgd_eff;
              ...
              T4 = pParam->BSIM4v5rd0 * 0.5f;
              Rd = pParam->BSIM4v5rdwmin + T3 * T4;
              dRd_dvg = T4 * dT3_dvg;
              dRd_dvb = T4 * dT3_dvb;

              T0 = 1.0f + here->BSIM4v5drainConductance * Rd;
	  ...
	  {   here->BSIM4v5gstot = here->BSIM4v5gstotd = here->BSIM4v5gstotg = 0.0f;
	      here->BSIM4v5gstots = here->BSIM4v5gstotb = 0.0f;
	      here->BSIM4v5gdtot = here->BSIM4v5gdtotd = here->BSIM4v5gdtotg = 0.0f;
              here->BSIM4v5gdtots = here->BSIM4v5gdtotb = 0.0f;
	  }

          /* Calculate GIDL current */
          vgs_eff = here->BSIM4v5vgs_eff;
          dvgs_eff_dvg = here->BSIM4v5dvgs_eff_dvg;
          T0 = 3.0f * model->BSIM4v5toxe;

          T1 = (vds - vgs_eff - pParam->BSIM4v5egidl ) / T0;
          if ((pParam->BSIM4v5agidl <= 0.0f) || (pParam->BSIM4v5bgidl <= 0.0f)
              || (T1 <= 0.0f) || (pParam->BSIM4v5cgidl <= 0.0f) || (vbd > 0.0f))
              Igidl = Ggidld = Ggidlg = Ggidlb = 0.0f;
          else {
              dT1_dVd = 1.0f / T0;
              dT1_dVg = -dvgs_eff_dvg * dT1_dVd;
              T2 = pParam->BSIM4v5bgidl / T1;
              if (T2 < 100.0f)
              {   Igidl = pParam->BSIM4v5agidl * pParam->BSIM4v5weffCJ * T1 * SPICE_EXP(-T2);
                  T3 = Igidl * (1.0f + T2) / T1;
                  Ggidld = T3 * dT1_dVd;
                  Ggidlg = T3 * dT1_dVg;
              }
              else
              {   Igidl = pParam->BSIM4v5agidl * pParam->BSIM4v5weffCJ * 3.720075976e-44f;
              ...
              T7 = T5 / T6;
              T8 = 3.0f * pParam->BSIM4v5cgidl * T4 / T6 / T6;
        ...
        /* Calculate GISL current  */
          ...
          if ((pParam->BSIM4v5agidl <= 0.0f) || (pParam->BSIM4v5bgidl <= 0.0f)
              || (T1 <= 0.0f) || (pParam->BSIM4v5cgidl <= 0.0f) || (vbs > 0.0f))
              Igisl = Ggisls = Ggislg = Ggislb = 0.0f;
          else {
              dT1_dVd = 1.0f / T0;
              dT1_dVg = -dvgd_eff_dvg * dT1_dVd;
              T2 = pParam->BSIM4v5bgidl / T1;
              if (T2 < 100.0f) 
              {   Igisl = pParam->BSIM4v5agidl * pParam->BSIM4v5weffCJ * T1 * SPICE_EXP(-T2);
                  T3 = Igisl * (1.0f + T2) / T1;
                  Ggisls = T3 * dT1_dVd;
                  Ggislg = T3 * dT1_dVg;
              }
              else 
              {   Igisl = pParam->BSIM4v5agidl * pParam->BSIM4v5weffCJ * 3.720075976e-44f;
          ...
          {   Vfb = here->BSIM4v5vfbzb;
              ...
              if (Vfb <= 0.0f)
                  T0 = SPICE_SQRT(V3 * V3 - 4.0f * DELTA_3 * Vfb);
              else
                  T0 = SPICE_SQRT(V3 * V3 + 4.0f * DELTA_3 * Vfb);
              T1 = 0.5f * (1.0f + V3 / T0);
              Vfbeff = Vfb - 0.5f * (V3 + T0);
              ...
              if (Voxacc < 0.0f) /* WDLiu: Avoiding numerical instability. */
                  Voxacc = dVoxacc_dVg = dVoxacc_dVb = 0.0f;

              T0 = 0.5f * pParam->BSIM4v5k1ox;
              T3 = Vgs_eff - Vfbeff - Vbseff - Vgsteff;
              if (pParam->BSIM4v5k1ox == 0.0f)
              ...
              {   Voxdepinv = -T3;
                  ...
                  dVoxdepinv_dVb = dVfbeff_dVb + 1.0f + dVgsteff_dVb;
	      }
              else
              {   T1 = SPICE_SQRT(T0 * T0 + T3);
                  T2 = T0 / T1;
                  Voxdepinv = pParam->BSIM4v5k1ox * (T1 - T0);
                  dVoxdepinv_dVg = T2 * (dVgs_eff_dVg - dVfbeff_dVg
				 - dVgsteff_dVg);
                  dVoxdepinv_dVd = -T2 * dVgsteff_dVd;
                  dVoxdepinv_dVb = -T2 * (dVfbeff_dVb + 1.0f + dVgsteff_dVb);
              }
	      ...
	      if(model->BSIM4v5igcMod == 1) {
		    ...
		    dVaux_dVd = 0.0f;
              ...
              if (VxNVt < -EXP_THRESHOLD)
              {   Vaux = T0 * SPICE_LOG(1.0f + MIN_EXP);
                  dVaux_dVg = dVaux_dVd = dVaux_dVb = 0.0f;
              }
              else if ((VxNVt >= -EXP_THRESHOLD) && (VxNVt <= EXP_THRESHOLD))
              {   ExpVxNVt = SPICE_EXP(VxNVt);
                  Vaux = T0 * SPICE_LOG(1.0f + ExpVxNVt);
                  dVaux_dVg = ExpVxNVt / (1.0f + ExpVxNVt);
		  if(model->BSIM4v5igcMod == 1) {
			dVaux_dVd = 0.0f;
                  	dVaux_dVb = 0.0f;
                  } else if (model->BSIM4v5igcMod == 2) {
		  ...
		  dVaux_dVg *= dVgs_eff_dVg;
              ...
              {   T6 = SPICE_EXP(T5);
                  dT6_dVg = T6 * T12 * (T3 - 2.0f * T4 * Voxdepinv);
              ...
              {   Pigcd = pParam->BSIM4v5pigcd;
                  dPigcd_dVg = dPigcd_dVd = dPigcd_dVb = 0.0f;
              }
              else
              {   T11 = pParam->BSIM4v5Bechvb * model->BSIM4v5toxe;
                  T12 = Vgsteff + 1.0e-20f;
                  T13 = T11 / T12 / T12;
                  T14 = -T13 / T12;
                  Pigcd = T13 * (1.0f - 0.5f * Vdseff / T12); 
                  dPigcd_dVg = T14 * (2.0f + 0.5f * (dVdseff_dVg
                              - 3.0f * Vdseff / T12));
                  dPigcd_dVd = 0.5f * T14 * dVdseff_dVd;
                  dPigcd_dVb = 0.5f * T14 * dVdseff_dVb;
              }
              ...
              T1 = T9 - 1.0f - 1.0e-4f;
              T10 = (T7 * T9 - T1) / T8;
              dT10_dVg = (dT7_dVg * T9 + (T7 - 1.0f) * dT9_dVg
                       - T10 * dT8_dVg) / T8;
              dT10_dVd = (dT7_dVd * T9 + (T7 - 1.0f) * dT9_dVd
                       - T10 * dT8_dVd) / T8;
              dT10_dVb = (dT7_dVb * T9 + (T7 - 1.0f) * dT9_dVb
                       - T10 * dT8_dVb) / T8;
              Igcd = Igc * T10;
              ...
              vgs_eff = SPICE_SQRT(T0 * T0 + 1.0e-4f);
              ...
              {   T6 = SPICE_EXP(T5);
                  dT6_dVg = T6 * T12 * (T3 - 2.0f * T4 * vgs_eff)
			  * dvgs_eff_dvg;
              }
              Igs = T11 * T2 * T6;
              ...
              vgd_eff = SPICE_SQRT(T0 * T0 + 1.0e-4f);
              ...
              {   T6 = SPICE_EXP(T5);
                  dT6_dVg = T6 * T12 * (T3 - 2.0f * T4 * vgd_eff)
                          * dvgd_eff_dvg;
              }
              Igd = T11 * T2 * T6;
          ...
          {   here->BSIM4v5Igcs = here->BSIM4v5gIgcsg = here->BSIM4v5gIgcsd
 			      = here->BSIM4v5gIgcsb = 0.0f;
              here->BSIM4v5Igcd = here->BSIM4v5gIgcdg = here->BSIM4v5gIgcdd
              		      = here->BSIM4v5gIgcdb = 0.0f;
              here->BSIM4v5Igs = here->BSIM4v5gIgsg = here->BSIM4v5gIgss = 0.0f;
              here->BSIM4v5Igd = here->BSIM4v5gIgdg = here->BSIM4v5gIgdd = 0.0f;
          }
	      ...
	      T1 = -Vgs_eff + Vbseff + Vfb;
              ...
              {   Vaux = T0 * SPICE_LOG(1.0f + MIN_EXP);
                  dVaux_dVg = dVaux_dVb = 0.0f;
              }
              else
              {   ExpVxNVt = SPICE_EXP(VxNVt);
                  Vaux = T0 * SPICE_LOG(1.0f + ExpVxNVt);
                  dVaux_dVb = ExpVxNVt / (1.0f + ExpVxNVt); 
	      ...
	      T2 = (Vgs_eff - Vbseff) * Vaux;
              ...
              T11 = 4.97232e-7f * pParam->BSIM4v5weff
		  * pParam->BSIM4v5leff * pParam->BSIM4v5ToxRatio;
              T12 = -7.45669e11f * model->BSIM4v5toxe;
		 ...
		 - T4 * Voxacc * Voxacc);
              ...
              {   T6 = SPICE_EXP(T5);
                  dT6_dVg = T6 * T12 * (T3 - 2.0f * T4 * Voxacc);
          ...
          {  here->BSIM4v5Igb = here->BSIM4v5gIgbg = here->BSIM4v5gIgbd
			    = here->BSIM4v5gIgbs = here->BSIM4v5gIgbb = 0.0f;   
          } /* End of Gate current */
	  ...
	  here->BSIM4v5cd = cdrain;
          ...
          {   Abulk = Abulk0 * pParam->BSIM4v5abulkCVfactor;
              ...
              T1 = SPICE_SQRT(T0 * T0 + 4.0f * DELTA_4 * Vdsat);
              if (T0 >= 0.0f)
                  Vdseff = Vdsat - 0.5f * (T0 + T1);
              else
	  ...
	  {   qgate  = qdrn = qsrc = qbulk = 0.0f;
              here->BSIM4v5cggb = here->BSIM4v5cgsb = here->BSIM4v5cgdb = 0.0f;
              here->BSIM4v5cdgb = here->BSIM4v5cdsb = here->BSIM4v5cddb = 0.0f;
              here->BSIM4v5cbgb = here->BSIM4v5cbsb = here->BSIM4v5cbdb = 0.0f;
              here->BSIM4v5csgb = here->BSIM4v5cssb = here->BSIM4v5csdb = 0.0f;
              here->BSIM4v5cgbb = here->BSIM4v5csbb = here->BSIM4v5cdbb = here->BSIM4v5cbbb = 0.0f;
              here->BSIM4v5cqdb = here->BSIM4v5cqsb = here->BSIM4v5cqgb 
                              = here->BSIM4v5cqbb = 0.0f;
              here->BSIM4v5gtau = 0.0f;
              goto finished;
          }
	  else if (model->BSIM4v5capMod == 0)
	  {
	      ...
	      {   qgate = CoxWL * Arg1;
                  ...
                  here->BSIM4v5cgdb = 0.0f;
                  here->BSIM4v5cgsb = CoxWL * (dVbseff_dVb - dVgs_eff_dVg);

                  here->BSIM4v5cdgb = 0.0f;
                  here->BSIM4v5cddb = 0.0f;
                  here->BSIM4v5cdsb = 0.0f;

                  here->BSIM4v5cbgb = -CoxWL * dVgs_eff_dVg;
                  here->BSIM4v5cbdb = 0.0f;
                  here->BSIM4v5cbsb = -here->BSIM4v5cgsb;
              } /* Arg1 <= 0.0f, end of accumulation */
	      else if (Vgst <= 0.0f)
	      {   T1 = 0.5f * pParam->BSIM4v5k1ox;
	          T2 = SPICE_SQRT(T1 * T1 + Arg1);
	          ...
	          here->BSIM4v5cgdb = 0.0f;
                  ...
                  here->BSIM4v5cbdb = 0.0f;
                  here->BSIM4v5cbsb = -here->BSIM4v5cgsb;
              } /* Vgst <= 0.0f, end of depletion */
	      else
	      {   One_Third_CoxWL = CoxWL / 3.0f;
                  Two_Third_CoxWL = 2.0f * One_Third_CoxWL;
		  ...
		  {   /* 0/100 Charge partition model */
		      ...
		      {   /* saturation region */
			        ...
			        - pParam->BSIM4v5phi - T1);
	                  ...
	                  here->BSIM4v5cggb = One_Third_CoxWL * (3.0f
			  ...
			  Alphaz = Vgst / Vdsat;
	                  ...
	                  T9 = 0.25f * CoxWL;
	                  T4 = T9 * Alphaz;
	                  T7 = 2.0f * Vds - T1 - 3.0f * T3;
	                  T8 = T3 - T1 - 2.0f * Vds;
	                  qgate = CoxWL * (Vgs_eff - Vfb 
			        - pParam->BSIM4v5phi - 0.5f * (Vds - T3));
	                  T10 = T4 * T8;
	                  qdrn = T4 * T7;
	                  qbulk = -(qgate + qdrn + T10);
  
                          T5 = T3 / T1;
                          here->BSIM4v5cggb = CoxWL * (1.0f - T5 * dVdsat_dVg)
					  * dVgs_eff_dVg;
                          T11 = -CoxWL * T5 * dVdsat_dVb;
                          here->BSIM4v5cgdb = CoxWL * (T2 - 0.5f + 0.5f * T5);
                          here->BSIM4v5cgsb = -(here->BSIM4v5cggb + T11
                                          + here->BSIM4v5cgdb);
                          T6 = 1.0f / Vdsat;
                          dAlphaz_dVg = T6 * (1.0f - Alphaz * dVdsat_dVg);
                          dAlphaz_dVb = -T6 * (dVth_dVb + Alphaz * dVdsat_dVb);
                          T7 = T9 * T7;
                          T8 = T9 * T8;
                          T9 = 2.0f * T4 * (1.0f - 3.0f * T5);
                          here->BSIM4v5cdgb = (T7 * dAlphaz_dVg - T9
					  * dVdsat_dVg) * dVgs_eff_dVg;
                          T12 = T7 * dAlphaz_dVb - T9 * dVdsat_dVb;
                          here->BSIM4v5cddb = T4 * (3.0f - 6.0f * T2 - 3.0f * T5);
		  ...
		  else if (model->BSIM4v5xpart < 0.5f)
		  {   /* 40/60 Charge partition model */
			  ...
			  T6 = 8.0f * Vdsat * Vdsat - 6.0f * Vdsat * Vds
			     + 1.2f * Vds * Vds;
			  T8 = T2 / T1;
			  T7 = Vds - T1 - T8 * T6;
			  qdrn = T4 * T7;
			  T7 *= T9;
			  tmp = T8 / T1;
			  tmp1 = T4 * (2.0f - 4.0f * tmp * T6
			       + T8 * (16.0f * Vdsat - 6.0f * Vds));

                          here->BSIM4v5cdgb = (T7 * dAlphaz_dVg - tmp1
					  * dVdsat_dVg) * dVgs_eff_dVg;
                          T10 = T7 * dAlphaz_dVb - tmp1 * dVdsat_dVb;
                          here->BSIM4v5cddb = T4 * (2.0f - (1.0f / (3.0f * T1
					  * T1) + 2.0f * tmp) * T6 + T8
					  * (6.0f * Vdsat - 2.4f * Vds));
		  ...
		  {   /* 50/50 partitioning */
			  ...
			  T12 = T0 * dVdsat_dVb - T7 * dAlphaz_dVb;
                          here->BSIM4v5cddb = T4 * (1.0f - 2.0f * T2 - T5);
                          here->BSIM4v5cdsb = -(here->BSIM4v5cdgb + T12
                                          + here->BSIM4v5cddb);

                          here->BSIM4v5cbgb = -(here->BSIM4v5cggb
					  + 2.0f * here->BSIM4v5cdgb);
                          here->BSIM4v5cbdb = -(here->BSIM4v5cgdb
					  + 2.0f * here->BSIM4v5cddb);
                          here->BSIM4v5cbsb = -(here->BSIM4v5cgsb
					  + 2.0f * here->BSIM4v5cdsb);
	  ...
	  {   if (Vbseff < 0.0f)
	      ...
	      {   VbseffCV = pParam->BSIM4v5phi - Phis;
		    ...
		    * pParam->BSIM4v5leffCV * here->BSIM4v5nf;
              ...
              {   Vgsteff = T0 * SPICE_LOG(1.0f + MIN_EXP);
                  dVgsteff_dVg = 0.0f;
              ...
              {   ExpVgst = SPICE_EXP(VgstNVt);
                  Vgsteff = T0 * SPICE_LOG(1.0f + ExpVgst);
                  dVgsteff_dVg = ExpVgst / (1.0f + ExpVgst);
		  ...
		  dT0_dVg = 1.0f / AbulkCV;
		  dT0_dVb = -VdsatCV * dAbulkCV_dVb / AbulkCV; 
		  T1 = SPICE_SQRT(T0 * T0 + 4.0f * DELTA_4 * VdsatCV);
                  dT1_dVg = (T0 + DELTA_4 + DELTA_4) / T1;
                  dT1_dVd = -T0 / T1;
                  dT1_dVb = dT1_dVg * dT0_dVb;
		  dT1_dVg *= dT0_dVg;
		  if (T0 >= 0.0f)
		  {   VdseffCV = VdsatCV - 0.5f * (T0 + T1);
                      dVdseffCV_dVg = 0.5f * (dT0_dVg - dT1_dVg);
                      dVdseffCV_dVd = 0.5f * (1.0f - dT1_dVd);
                      dVdseffCV_dVb = 0.5f * (dT0_dVb - dT1_dVb);
		  }
                  else
                  {   T3 = (DELTA_4 + DELTA_4) / (T1 - T0);
		      T4 = 1.0f - T3;
		      ...
		      VdseffCV = VdsatCV * T4;
                      ...
                      dVdseffCV_dVd = T5 * (dT1_dVd + 1.0f);
                      dVdseffCV_dVb = dT0_dVb * (1.0f - T5) + T5 * dT1_dVb;
                  }
		  ...
		  T3 = T0 * T2;
                  ...
                  T4 = (1.0f - 12.0f * T2 * T2 * AbulkCV);
                  T5 = (6.0f * T0 * (4.0f * Vgsteff - T0) / (T1 * T1) - 0.5f);
                  T6 = 12.0f * T2 * T2 * Vgsteff;

                  qgate = CoxWL * (Vgsteff - 0.5f * VdseffCV + T3);
		  ...
		  T7 = 1.0f - AbulkCV;
                  qbulk = CoxWL * T7 * (0.5f * VdseffCV - T3);
		  T4 = -T7 * (T4 - 1.0f);
		  T5 = -T7 * T5;
		  T6 = -(T7 * T6 + (0.5f * VdseffCV - T3));
		  ...
		  {   /* 0/100 Charge petition model */
		      T1 = T1 + T1;
                      qsrc = -CoxWL * (0.5f * Vgsteff + 0.25f * T0
			   - T0 * T0 / T1);
		      T7 = (4.0f * Vgsteff - T0) / (T1 * T1);
		      T4 = -(0.5f + 24.0f * T0 * T0 / (T1 * T1));
		      T5 = -(0.25f * AbulkCV - 12.0f * AbulkCV * T0 * T7);
                      T6 = -(0.25f * VdseffCV - 12.0f * T0 * VdseffCV * T7);
		  ...
		  {   /* 40/60 Charge petition model */
		      T1 = T1 / 12.0f;
		      T2 = 0.5f * CoxWL / (T1 * T1);
		      T3 = Vgsteff * (2.0f * T0 * T0 / 3.0f + Vgsteff
			 * (Vgsteff - 4.0f * T0 / 3.0f))
			 - 2.0f * T0 * T0 * T0 / 15.0f;
		      qsrc = -T2 * T3;
		      T7 = 4.0f / 3.0f * Vgsteff * (Vgsteff - T0)
			 + 0.4f * T0 * T0;
		      T4 = -2.0f * qsrc / T1 - T2 * (Vgsteff * (3.0f
			 * Vgsteff - 8.0f * T0 / 3.0f)
			 + 2.0f * T0 * T0 / 3.0f);
		  ...
		  if (here->BSIM4v5vfbzb <= 0.0f)
		      T0 = SPICE_SQRT(V3 * V3 - 4.0f * DELTA_3 * here->BSIM4v5vfbzb);
		  else
		      T0 = SPICE_SQRT(V3 * V3 + 4.0f * DELTA_3 * here->BSIM4v5vfbzb);

		  T1 = 0.5f * (1.0f + V3 / T0);
		  Vfbeff = here->BSIM4v5vfbzb - 0.5f * (V3 + T0);
		  dVfbeff_dVg = T1 * dVgs_eff_dVg;
		  dVfbeff_dVb = -T1 * dVbseffCV_dVb;

                  Cox = model->BSIM4v5coxp;
                  Tox = 1.0e8f * model->BSIM4v5toxp;
                  ...
                  {   Tcen = pParam->BSIM4v5ldeb * SPICE_EXP(tmp);
                  ...
                  LINK = 1.0e-3f * model->BSIM4v5toxp;
                  V3 = pParam->BSIM4v5ldeb - Tcen - LINK;
                  V4 = SPICE_SQRT(V3 * V3 + 4.0f * LINK * pParam->BSIM4v5ldeb);
                  Tcen = pParam->BSIM4v5ldeb - 0.5f * (V3 + V4);
                  T1 = 0.5f * (1.0f + V3 / V4);
                  dTcen_dVg *= T1;
                  dTcen_dVb *= T1;
		  ...
		  if (pParam->BSIM4v5k1ox <= 0.0f)
		  {   Denomi = 0.25f * pParam->BSIM4v5moin * Vtm;
                      T0 = 0.5f * pParam->BSIM4v5sqrtPhi;
		  }
		  else
		  ...
		  DeltaPhi = Vtm * SPICE_LOG(1.0f + T1 * Vgsteff / Denomi);
		  dDeltaPhi_dVg = 2.0f * Vtm * (T1 -T0) / (Denomi + T1 * Vgsteff);
		  /* End of delta Phis */

		  /* VgDP = Vgsteff - DeltaPhi */
		  T0 = Vgsteff - DeltaPhi - 0.001f;
		  dT0_dVg = 1.0f - dDeltaPhi_dVg;
		  T1 = SPICE_SQRT(T0 * T0 + Vgsteff * 0.004f);
		  VgDP = 0.5f * (T0 + T1);
		  dVgDP_dVg = 0.5f * (dT0_dVg + (T0 * dT0_dVg + 0.002f) / T1);                  
                  
                  Tox += Tox; /* WDLiu: Tcen reevaluated below due to different Vgsteff */
                  T0 = (Vgsteff + here->BSIM4v5vtfbphi2) / Tox;
                  tmp = SPICE_EXP(0.7f * SPICE_LOG(T0));
                  T1 = 1.0f + tmp;
                  T2 = 0.7f * tmp / (T0 * Tox);
                  Tcen = 1.9e-9f / T1;
		  ...
		  CoxWLcen = CoxWL * Coxeff / model->BSIM4v5coxe;
                  ...
                  T0 = AbulkCV * VdseffCV;
		  T1 = VgDP;
                  T2 = 12.0f * (T1 - 0.5f * T0 + 1.0e-20f);
                  T3 = T0 / T2;
                  T4 = 1.0f - 12.0f * T3 * T3;
                  T5 = AbulkCV * (6.0f * T0 * (4.0f * T1 - T0) / (T2 * T2) - 0.5f);
		  T6 = T5 * VdseffCV / AbulkCV;

                  qgate = CoxWLcen * (T1 - T0 * (0.5f - T3));
		  QovCox = qgate / Coxeff;
		  ...
		  Cgg1 = Cgg1 * dVgsteff_dVg + QovCox * dCoxeff_dVg;
                  ...
                  T7 = 1.0f - AbulkCV;
                  T8 = T2 * T2;
                  T9 = 12.0f * T7 * T0 * T0 / (T8 * AbulkCV);
                  T10 = T9 * dVgDP_dVg;
                  T11 = -T7 * T5 / AbulkCV;
                  T12 = -(T9 * T1 / AbulkCV + VdseffCV * (0.5f - T0 / T2));

		  qbulk = CoxWLcen * T7 * (0.5f * VdseffCV - T0 * VdseffCV / T2);
		  QovCox = qbulk / Coxeff;
		  ...
		  Cbg1 = Cbg1 * dVgsteff_dVg + QovCox * dCoxeff_dVg;
                  ...
                  if (model->BSIM4v5xpart > 0.5f)
		  {   /* 0/100 partition */
		      qsrc = -CoxWLcen * (T1 / 2.0f + T0 / 4.0f 
			   - 0.5f * T0 * T0 / T2);
		      QovCox = qsrc / Coxeff;
		      T2 += T2;
		      T3 = T2 * T2;
		      T7 = -(0.25f - 12.0f * T0 * (4.0f * T1 - T0) / T3);
		      T4 = -(0.5f + 24.0f * T0 * T0 / T3) * dVgDP_dVg;
		      T5 = T7 * AbulkCV;
		      T6 = T7 * VdseffCV;
		  ...
		  {   /* 40/60 partition */
		      T2 = T2 / 12.0f;
		      T3 = 0.5f * CoxWLcen / (T2 * T2);
                      T4 = T1 * (2.0f * T0 * T0 / 3.0f + T1 * (T1 - 4.0f 
                         * T0 / 3.0f)) - 2.0f * T0 * T0 * T0 / 15.0f;
		      qsrc = -T3 * T4;
		      QovCox = qsrc / Coxeff;
		      T8 = 4.0f / 3.0f * T1 * (T1 - T0) + 0.4f * T0 * T0;
		      T5 = -2.0f * qsrc / T2 - T3 * (T1 * (3.0f * T1 - 8.0f 
			 * T0 / 3.0f) + 2.0f * T0 * T0 / 3.0f);
	      ...
	      if (here->BSIM4v5trnqsMod)
              {   error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qcheq);
                  if (error)
                      return(error);
	      }
          }
...
finished: 
	  ...
	  {   czbd = model->BSIM4v5DunitAreaTempJctCap * here->BSIM4v5Adeff; /* bug fix */
	      ...
	      if (vbs_jct == 0.0f)
	      {   *(ckt->CKTstate0 + here->BSIM4v5qbs) = 0.0f;
                  here->BSIM4v5capbs = czbs + czbssw + czbsswg;
	      }
	      else if (vbs_jct < 0.0f)
	      {   if (czbs > 0.0f)
		  {   arg = 1.0f - vbs_jct / model->BSIM4v5PhiBS;
		      if (MJS == 0.5f)
                          sarg = 1.0f / SPICE_SQRT(arg);
		      else
                          sarg = SPICE_EXP(-MJS * SPICE_LOG(arg));
                      *(ckt->CKTstate0 + here->BSIM4v5qbs) = model->BSIM4v5PhiBS * czbs 
			               * (1.0f - arg * sarg) / (1.0f - MJS);
		      here->BSIM4v5capbs = czbs * sarg;
		  }
		  else
		  {   *(ckt->CKTstate0 + here->BSIM4v5qbs) = 0.0f;
		      here->BSIM4v5capbs = 0.0f;
		  }
		  if (czbssw > 0.0f)
		  {   arg = 1.0f - vbs_jct / model->BSIM4v5PhiBSWS;
		      if (MJSWS == 0.5f)
                          sarg = 1.0f / SPICE_SQRT(arg);
		      else
                          sarg = SPICE_EXP(-MJSWS * SPICE_LOG(arg));
                      *(ckt->CKTstate0 + here->BSIM4v5qbs) += model->BSIM4v5PhiBSWS * czbssw
				       * (1.0f - arg * sarg) / (1.0f - MJSWS);
                      here->BSIM4v5capbs += czbssw * sarg;
		  }
		  if (czbsswg > 0.0f)
		  {   arg = 1.0f - vbs_jct / model->BSIM4v5PhiBSWGS;
		      if (MJSWGS == 0.5f)
                          sarg = 1.0f / SPICE_SQRT(arg);
		      else
                          sarg = SPICE_EXP(-MJSWGS * SPICE_LOG(arg));
                      *(ckt->CKTstate0 + here->BSIM4v5qbs) += model->BSIM4v5PhiBSWGS * czbsswg
				       * (1.0f - arg * sarg) / (1.0f - MJSWGS);
	      ...
	      {   T0 = czbs + czbssw + czbsswg;
                  ...
                  *(ckt->CKTstate0 + here->BSIM4v5qbs) = vbs_jct * (T0 + 0.5f * T1);
                  here->BSIM4v5capbs = T0 + T1;
              }

              /* Drain Bulk Junction */
	      if (vbd_jct == 0.0f)
	      {   *(ckt->CKTstate0 + here->BSIM4v5qbd) = 0.0f;
                  here->BSIM4v5capbd = czbd + czbdsw + czbdswg;
	      }
	      else if (vbd_jct < 0.0f)
	      {   if (czbd > 0.0f)
		  {   arg = 1.0f - vbd_jct / model->BSIM4v5PhiBD;
		      if (MJD == 0.5f)
                          sarg = 1.0f / SPICE_SQRT(arg);
		      else
                          sarg = SPICE_EXP(-MJD * SPICE_LOG(arg));
                      *(ckt->CKTstate0 + here->BSIM4v5qbd) = model->BSIM4v5PhiBD* czbd 
			               * (1.0f - arg * sarg) / (1.0f - MJD);
                      here->BSIM4v5capbd = czbd * sarg;
		  }
		  else
		  {   *(ckt->CKTstate0 + here->BSIM4v5qbd) = 0.0f;
                      here->BSIM4v5capbd = 0.0f;
		  }
		  if (czbdsw > 0.0f)
		  {   arg = 1.0f - vbd_jct / model->BSIM4v5PhiBSWD;
		      if (MJSWD == 0.5f)
                          sarg = 1.0f / SPICE_SQRT(arg);
		      else
                          sarg = SPICE_EXP(-MJSWD * SPICE_LOG(arg));
                      *(ckt->CKTstate0 + here->BSIM4v5qbd) += model->BSIM4v5PhiBSWD * czbdsw 
			               * (1.0f - arg * sarg) / (1.0f - MJSWD);
                      here->BSIM4v5capbd += czbdsw * sarg;
		  }
		  if (czbdswg > 0.0f)
		  {   arg = 1.0f - vbd_jct / model->BSIM4v5PhiBSWGD;
		      if (MJSWGD == 0.5f)
                          sarg = 1.0f / SPICE_SQRT(arg);
		      else
                          sarg = SPICE_EXP(-MJSWGD * SPICE_LOG(arg));
                      *(ckt->CKTstate0 + here->BSIM4v5qbd) += model->BSIM4v5PhiBSWGD * czbdswg
				       * (1.0f - arg * sarg) / (1.0f - MJSWGD);
	      ...
	      {   T0 = czbd + czbdsw + czbdswg;
                  ...
                  *(ckt->CKTstate0 + here->BSIM4v5qbd) = vbd_jct * (T0 + 0.5f * T1);
	      ...
	      {   ckt->CKTnoncon++;
              ...
              {   if (here->BSIM4v5mode >= 0)
			    ...
			    + here->BSIM4v5Igidl - here->BSIM4v5cbd;
                  ...
                  tol0 = ckt->CKTreltol * MAX(SPICE_FABS(cdhat), SPICE_FABS(Idtot))
                       + ckt->CKTabstol;
		  tol1 = ckt->CKTreltol * MAX(SPICE_FABS(cseshat), SPICE_FABS(Isestot))
                       + ckt->CKTabstol;
                  tol2 = ckt->CKTreltol * MAX(SPICE_FABS(cdedhat), SPICE_FABS(Idedtot))
                       + ckt->CKTabstol;
                  tol3 = ckt->CKTreltol * MAX(SPICE_FABS(cgshat), SPICE_FABS(Igstot))
                       + ckt->CKTabstol;
                  tol4 = ckt->CKTreltol * MAX(SPICE_FABS(cgdhat), SPICE_FABS(Igdtot))
                       + ckt->CKTabstol;
                  tol5 = ckt->CKTreltol * MAX(SPICE_FABS(cgbhat), SPICE_FABS(Igbtot))
                       + ckt->CKTabstol;
                  if ((SPICE_FABS(cdhat - Idtot) >= tol0) || (SPICE_FABS(cseshat - Isestot) >= tol1)
		      || (SPICE_FABS(cdedhat - Idedtot) >= tol2))
                  {   ckt->CKTnoncon++;
                  }
		  else if ((SPICE_FABS(cgshat - Igstot) >= tol3) || (SPICE_FABS(cgdhat - Igdtot) >= tol4)
		      || (SPICE_FABS(cgbhat - Igbtot) >= tol5))
                  {   ckt->CKTnoncon++;
                  }
                  else
                  {   Ibtot = here->BSIM4v5cbs + here->BSIM4v5cbd
			    - here->BSIM4v5Igidl - here->BSIM4v5Igisl - here->BSIM4v5csub;
                      tol6 = ckt->CKTreltol * MAX(SPICE_FABS(cbhat), SPICE_FABS(Ibtot))
                          + ckt->CKTabstol;
                      if (SPICE_FABS(cbhat - Ibtot) > tol6)
		      {   ckt->CKTnoncon++;
                      }
                  }
#endif /* NEWCONV */
	  ...
	  *(ckt->CKTstate0 + here->BSIM4v5vgms) = vgms;
	  ...
	  {   T0 = vgdx + DELTA_1;
	      T1 = SPICE_SQRT(T0 * T0 + 4.0f * DELTA_1);
	      T2 = 0.5f * (T0 - T1);

	      T3 = pParam->BSIM4v5weffCV * pParam->BSIM4v5cgdl;
	      T4 = SPICE_SQRT(1.0f - 4.0f * T2 / pParam->BSIM4v5ckappad); 
	      cgdo = pParam->BSIM4v5cgdo + T3 - T3 * (1.0f - 1.0f / T4)
		   * (0.5f - 0.5f * T0 / T1);
	      qgdo = (pParam->BSIM4v5cgdo + T3) * vgdx - T3 * (T2
		   + 0.5f * pParam->BSIM4v5ckappad * (T4 - 1.0f));

	      T0 = vgsx + DELTA_1;
	      T1 = SPICE_SQRT(T0 * T0 + 4.0f * DELTA_1);
	      T2 = 0.5f * (T0 - T1);
	      T3 = pParam->BSIM4v5weffCV * pParam->BSIM4v5cgsl;
	      T4 = SPICE_SQRT(1.0f - 4.0f * T2 / pParam->BSIM4v5ckappas);
	      cgso = pParam->BSIM4v5cgso + T3 - T3 * (1.0f - 1.0f / T4)
		   * (0.5f - 0.5f * T0 / T1);
	      qgso = (pParam->BSIM4v5cgso + T3) * vgsx - T3 * (T2
		   + 0.5f * pParam->BSIM4v5ckappas * (T4 - 1.0f));
	  }
...
line755:
		  ...
		  gcbbb = -(gcbdb + gcbgb + gcbsb + gcbgmb);
                  ...
                  ggtg = ggtd = ggtb = ggts = 0.0f;
		  sxpart = 0.6f;
                  dxpart = 0.4f;
		  ddxpart_dVd = ddxpart_dVg = ddxpart_dVb = ddxpart_dVs = 0.0f;
		  dsxpart_dVd = dsxpart_dVg = dsxpart_dVb = dsxpart_dVs = 0.0f;
              }
              else
		  ...
		  gqdef = ScalingFactor * ag0;
                  ...
                  if (SPICE_FABS(qcheq) <= 1.0e-5f * CoxWL)
                  {   if (model->BSIM4v5xpart < 0.5f)
                      {   dxpart = 0.4f;
                      }
                      else if (model->BSIM4v5xpart > 0.5f)
                  ...
                  {   gcgmgmb = (cgdo + cgso + pParam->BSIM4v5cgbo) * ag0;
                      ...
                      gcdgb = gcsgb = gcbgb = 0.0f;
		      gcggb = gcgdb = gcgsb = gcgbb = 0.0f;
          ...
          {   *(ckt->CKTstate0 + here->BSIM4v5qcdump) = qdef * ScalingFactor;
              ...
              error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qcdump);
              if (error)
                  return(error);
          }
	  ...
	  if (here->BSIM4v5rgateMod == 3)
	      *(ckt->CKTstate0 + here->BSIM4v5qgmid) = qgmid;
          ...
          error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qb);
          if (error) 
              return(error);
          error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qg);
          if (error) 
              return(error);
          error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qd);
          if (error) 
              return(error);

          if (here->BSIM4v5rgateMod == 3)
          {   error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qgmid);
              if (error) return(error);
          }

          if (here->BSIM4v5rbodyMod)
          {   error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qbs);
              if (error) 
                  return(error);
              error = NIintegrate(ckt, &geq, &ceq, 0.0f, here->BSIM4v5qbd);
              if (error) 
                  return(error);
          }
...
line850:
          ...
          ceqqg = ceqqb = ceqqd = 0.0f;
          ceqqjd = ceqqjs = 0.0f;
          cqcheq = cqdef = 0.0f;

          gcdgb = gcddb = gcdsb = gcdbb = 0.0f;
          gcsgb = gcsdb = gcssb = gcsbb = 0.0f;
          gcggb = gcgdb = gcgsb = gcgbb = 0.0f;
          gcbdb = gcbgb = gcbsb = gcbbb = 0.0f;

	  gcgmgmb = gcgmdb = gcgmsb = gcgmbb = 0.0f;
	  gcdgmb = gcsgmb = gcbgmb = ceqqgmid = 0.0f;
          gcdbdb = gcsbsb = 0.0f;

	  gqdef = gcqgb = gcqdb = gcqsb = gcqbb = 0.0f;
          ggtg = ggtd = ggtb = ggts = 0.0f;
          sxpart = (1.0f - (dxpart = (here->BSIM4v5mode > 0) ? 0.4f : 0.6f));
	  ddxpart_dVd = ddxpart_dVg = ddxpart_dVb = ddxpart_dVs = 0.0f;
	  dsxpart_dVd = dsxpart_dVg = dsxpart_dVb = dsxpart_dVs = 0.0f;
...
line900:
	  ...
	  {   Gm = here->BSIM4v5gm;
	      ...
	      {   gIstotg = gIstotd = gIstots = gIstotb = Istoteq = 0.0f;
		  gIdtotg = gIdtotd = gIdtots = gIdtotb = Idtoteq = 0.0f;
	      }
              ...
              {   gIbtotg = here->BSIM4v5gIgbg;
                  ...
                  gIbtotg = gIbtotd = gIbtots = gIbtotb = Ibtoteq = 0.0f;
	          ...
	          gIgtotg = gIgtotd = gIgtots = gIgtotb = Igtoteq = 0.0f;
	          ...
	          ceqgcrg = gcrg = gcrgd = gcrgg = gcrgs = gcrgb = 0.0f;
          }
	  else
	  {   Gm = -here->BSIM4v5gm;
              Gmbs = -here->BSIM4v5gmbs;
          ...
          {   gstot = gstotd = gstotg = gstots = gstotb = ceqgstot = 0.0f;
              gdtot = gdtotd = gdtotg = gdtots = gdtotb = ceqgdtot = 0.0f;
          }
...
int BSIM4v5polyDepletion(
    ...
    SPICE_REAL Vgs,
    SPICE_REAL *Vgs_eff,
    SPICE_REAL *dVgs_eff_dVg)
{
    SPICE_REAL T1, T2, T3, T4, T5, T6, T7, T8;

    /* Poly Gate Si Depletion Effect */
    if ((ngate > 1.0e18f) && 
        (ngate < 1.0e25f) && (Vgs > phi)) {
        T1 = 1.0e6f * CHARGE * EPSSI * ngate / (coxe * coxe);
        T8 = Vgs - phi;
        T4 = SPICE_SQRT(1.0f + 2.0f * T8 / T1);
        T2 = 2.0f * T8 / (T4 + 1.0f);
        T3 = 0.5f * T2 * T2 / T1; /* T3 = Vpoly */
        T7 = 1.12f - T3 - 0.05f;
        T6 = SPICE_SQRT(T7 * T7 + 0.224f);
        T5 = 1.12f - 0.5f * (T7 + T6);
        *Vgs_eff = Vgs - T5;
        *dVgs_eff_dVg = 1.0f - (0.5f - 0.5f / T4) * (1.0f + T7 / T6); 
    }
    else {
        *Vgs_eff = Vgs;
        *dVgs_eff_dVg = 1.0f;
